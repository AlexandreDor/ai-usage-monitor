  ...
  const translations = {
    en: {
      ...
      dashboard: {
        ...
        paceActual: 'Actual remaining: {value}',
        paceIdeal: 'Ideal remaining: {value}',
        paceActualUnavailable: 'Actual remaining: Unavailable',
        paceIdealUnavailable: 'Ideal remaining: Unavailable',
        paceDelta: '{sign}{value} pts; {relative}% {direction}',
        paceDeltaPoints: '{sign}{value} pts; {direction}',
        history: 'History',
        historyUnavailable: 'History unavailable',
        historyUnavailableWithReason: 'History unavailable: {reason}',
        historyTitleSingle: 'History / {start}',
        historyTitleRange: 'History / {start} - {end}',
        historySummarySingle: '1 sample from {from} to {to}. Latest values: {fiveHour}; {weekly}; {ideal}; {forecast24h}; {forecast6h}.',
        historySummaryMany: '{samples} samples from {from} to {to}. Latest values: {fiveHour}; {weekly}; {ideal}; {forecast24h}; {forecast6h}.',
        showHistoryTable: 'Show history data table',
        historyTableCaption: 'Quota and forecast history',
        historyDate: 'Date',
        historyFiveHour: '5-hour remaining',
        historyWeekly: 'Weekly remaining',
        historyIdeal: 'Ideal weekly remaining',
        historyForecast24h: 'Forecast 24h',
        historyForecast6h: 'Forecast 6h',
    ...
    fr: {
      ...
      dashboard: {
        ...
        paceActual: 'Restant réel : {value}',
        paceIdeal: 'Restant idéal : {value}',
        paceActualUnavailable: 'Restant réel : indisponible',
        paceIdealUnavailable: 'Restant idéal : indisponible',
        paceDelta: '{sign}{value} pts ; {relative} % {direction}',
        paceDeltaPoints: '{sign}{value} pts ; {direction}',
        history: 'Historique',
        historyUnavailable: 'Historique indisponible',
        historyUnavailableWithReason: 'Historique indisponible : {reason}',
        historyTitleSingle: 'Historique / {start}',
        historyTitleRange: 'Historique / {start} - {end}',
        historySummarySingle: '1 échantillon du {from} au {to}. Dernières valeurs : {fiveHour} ; {weekly} ; {ideal} ; {forecast24h} ; {forecast6h}.',
        historySummaryMany: '{samples} échantillons du {from} au {to}. Dernières valeurs : {fiveHour} ; {weekly} ; {ideal} ; {forecast24h} ; {forecast6h}.',
        showHistoryTable: 'Afficher le tableau des données historiques',
        historyTableCaption: 'Historique des quotas et prévisions',
        historyDate: 'Date',
        historyFiveHour: 'Restant sur 5 heures',
        historyWeekly: 'Restant hebdomadaire',
        historyIdeal: 'Restant hebdomadaire idéal',
        historyForecast24h: 'Prévision 24 h',
        historyForecast6h: 'Prévision 6 h',
