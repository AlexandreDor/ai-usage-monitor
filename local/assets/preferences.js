  ...
  const translations = {
    en: {
      ...
      analytics: {
        ...
        weeklyLimitValueWindow: 'Rolling window · 1 h · USD',
        weeklyLimitValueDescription: 'API-equivalent Codex cost divided by the weekly quota fraction consumed in the same rolling one-hour window.',
        ...
        weeklyLimitValueSummary: '{valid} valid one-hour estimates from {from} to {to}; {unavailable} unavailable or qualified points.',
        ...
        weeklyValueAvailable: 'Comparable Codex window',
        ...
        weeklyValueReasonInvalidEvent: 'A Codex token event has invalid counters.',
        ...
        weeklyValueReasonMissingPrice: 'A Codex model has no positive catalog price.',
        weeklyValueReasonNoCost: 'No positive API-equivalent cost was observed.',
        weeklyValueReasonNoEvents: 'No Codex token events were observed.',
        ...
        weeklyValueReasonWindowDuration: 'No comparable window between 45 and 75 minutes was found.',
    ...
    fr: {
      ...
      analytics: {
        ...
        weeklyLimitValueWindow: 'Fenêtre glissante · 1 h · USD',
        weeklyLimitValueDescription: 'Coût Codex équivalent API divisé par la fraction de quota hebdomadaire consommée dans la même fenêtre glissante d’une heure.',
        ...
        weeklyLimitValueSummary: '{valid} estimations valides d’une heure du {from} au {to} ; {unavailable} points indisponibles ou qualifiés.',
        ...
        weeklyValueAvailable: 'Fenêtre Codex comparable',
        ...
        weeklyValueReasonInvalidEvent: 'Un événement de tokens Codex possède des compteurs invalides.',
        ...
        weeklyValueReasonMissingPrice: 'Un modèle Codex n’a pas de prix catalogue positif.',
        weeklyValueReasonNoCost: 'Aucun coût équivalent API positif n’a été observé.',
        weeklyValueReasonNoEvents: 'Aucun événement de tokens Codex n’a été observé.',
        ...
        weeklyValueReasonWindowDuration: 'Aucune fenêtre comparable de 45 à 75 minutes n’a été trouvée.',
