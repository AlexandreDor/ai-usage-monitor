  ...
  const translations = {
    en: {
      ...
      analytics: {
        ...
        weeklyValueModelDescription: 'Per-model values come from exclusive windows when available. Mixed windows may use a low-confidence fit from prior non-overlapping windows in the same quota cycle; uncollected usage may affect estimates.',
        weeklyValueReasonMixedModels: 'Window contains multiple models and could not be attributed safely.',
        weeklyValueInferred: 'Inferred from shared quota (low confidence)',
        ...
        weeklyLimitValueDescription: 'API-equivalent cost from all locally collected sources divided by the shared weekly quota fraction consumed in the same rolling twelve-hour window. Per-model mixed-window values are inferred, not model-level quota observations.',
        ...
        gptModelsUnavailable: 'No supported GPT model is available in this archive (GPT-6 Astra or GPT-5.6 Sol, Terra, Luna).',
    ...
    fr: {
      ...
      analytics: {
        ...
        weeklyValueModelDescription: 'Les valeurs par modèle proviennent des fenêtres exclusives quand elles existent. Les fenêtres mixtes peuvent utiliser un ajustement à faible confiance fondé sur des fenêtres antérieures sans chevauchement du même cycle de quota ; les usages non collectés peuvent affecter les estimations.',
        weeklyValueReasonMixedModels: 'La fenêtre contient plusieurs modèles et n’a pas pu être attribuée de façon fiable.',
        weeklyValueInferred: 'Inférée depuis le quota partagé (confiance faible)',
        ...
        weeklyLimitValueDescription: 'Coût équivalent API de toutes les sources collectées localement divisé par la fraction du quota hebdomadaire partagé consommée dans la même fenêtre glissante de douze heures. Les valeurs par modèle des fenêtres mixtes sont inférées et ne sont pas des relevés de quota par modèle.',
        ...
        gptModelsUnavailable: 'Aucun modèle GPT pris en charge n’est disponible dans cette archive (GPT-6 Astra ou GPT-5.6 Sol, Terra, Luna).',
