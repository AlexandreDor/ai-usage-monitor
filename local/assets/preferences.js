  ...
  const translations = {
    en: {
      ...
      analytics: {
        ...
        weeklyValueModel: 'Estimate',
        weeklyValueAllModels: 'All models (aggregate)',
        weeklyValueModelDescription: 'Per-model estimates use only windows containing that GPT model alone. Mixed-model windows cannot be attributed; uncollected usage may affect estimates.',
        weeklyValueReasonMixedModels: 'Window contains another model; shared quota cannot be attributed.',
    ...
    fr: {
      ...
      analytics: {
        ...
        weeklyValueModel: 'Estimation',
        weeklyValueAllModels: 'Tous les modèles (agrégat)',
        weeklyValueModelDescription: 'Les estimations par modèle utilisent uniquement les fenêtres où ce modèle GPT apparaît seul. Les fenêtres avec plusieurs modèles ne sont pas attribuables ; les usages non collectés peuvent affecter les estimations.',
        weeklyValueReasonMixedModels: 'La fenêtre contient un autre modèle ; le quota partagé ne peut pas être attribué.',
