  ...
  const translations = {
    en: {
      ...
      analytics: {
        ...
        gptModelsUnavailable: 'No supported GPT model is available in this archive (GPT-6 Astra, Sol, Luna or GPT-5.6 Sol, Terra, Luna).',
    ...
    fr: {
      ...
      analytics: {
        ...
        gptModelsUnavailable: 'Aucun modèle GPT pris en charge n’est disponible dans cette archive (GPT-6 Astra, Sol, Luna ou GPT-5.6 Sol, Terra, Luna).',
