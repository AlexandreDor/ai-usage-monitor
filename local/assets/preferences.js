  ...
  const translations = {
    en: {
      ...
      dashboard: {
        ...
        showFiveHourLimit: 'Show 5-hour limit',
        hideFiveHourLimit: 'Hide 5-hour limit',
    ...
    fr: {
      ...
      dashboard: {
        ...
        showFiveHourLimit: 'Afficher la limite sur 5 heures',
        hideFiveHourLimit: 'Masquer la limite sur 5 heures',
