  ...
  const translations = {
    en: {
      ...
      analytics: {
        ...
        weeklyValueModelDescription: 'Per-model values come from exclusive windows when available. Mixed usage may use a fit trained on adaptive non-overlapping intervals from the last 28 days. High-uncertainty estimates remain visible with dashed sensitivity bounds. The last accepted value may be carried for up to 7 days across ordinary gaps and weekly resets.',
        ...
        weeklyLimitValueQualityLegend: 'Quality: good · low confidence · high uncertainty · volatile. Sensitivity ranges assume a one-point error in each quota observation; they are not statistical confidence intervals. Arrows mark bounds beyond the chart; the table gives their values.',
    ...
    fr: {
      ...
      analytics: {
        ...
        weeklyValueModelDescription: 'Les valeurs par modèle proviennent des fenêtres exclusives quand elles existent. Un usage mixte peut utiliser un ajustement entraîné sur des intervalles adaptatifs sans chevauchement des 28 derniers jours. Les estimations à forte incertitude restent visibles avec des bornes de sensibilité en pointillés. La dernière valeur acceptée peut être reportée jusqu’à 7 jours pendant les lacunes ordinaires et les resets hebdomadaires.',
        ...
        weeklyLimitValueQualityLegend: 'Qualité : bonne · confiance faible · forte incertitude · volatile. Les plages de sensibilité supposent une erreur d’un point dans chaque observation de quota ; ce ne sont pas des intervalles de confiance statistiques. Les flèches signalent les bornes hors du graphique ; le tableau donne leurs valeurs.',
