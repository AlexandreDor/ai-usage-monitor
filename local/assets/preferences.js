  ...
  const translations = {
    en: {
      ...
      analytics: {
        ...
        weeklyLimitValueWindow: 'Rolling window · 2 h · USD',
        weeklyLimitValueDescription: 'API-equivalent cost from all locally collected sources divided by the weekly quota fraction consumed in the same rolling two-hour window.',
        ...
        weeklyLimitValueSummary: '{valid} valid two-hour estimates from {from} to {to}; {unavailable} unavailable or qualified points.',
        ...
        weeklyValueReasonWindowDuration: 'No comparable window between 1 h 45 min and 2 h 15 min was found.',
    ...
    fr: {
      ...
      analytics: {
        ...
        weeklyLimitValueWindow: 'Fenêtre glissante · 2 h · USD',
        weeklyLimitValueDescription: 'Coût équivalent API de toutes les sources collectées localement divisé par la fraction de quota hebdomadaire consommée dans la même fenêtre glissante de deux heures.',
        ...
        weeklyLimitValueSummary: '{valid} estimations valides de deux heures du {from} au {to} ; {unavailable} points indisponibles ou qualifiés.',
        ...
        weeklyValueReasonWindowDuration: 'Aucune fenêtre comparable de 1 h 45 à 2 h 15 n’a été trouvée.',
