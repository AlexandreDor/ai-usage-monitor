  ...
  const translations = {
    en: {
      ...
      analytics: {
        ...
        weeklyValueModelDescription: 'Per-model values come from exclusive windows when available. Mixed usage may use a low-confidence fit trained on adaptive non-overlapping intervals from the last 28 days. The last accepted value may be carried for up to 7 days across ordinary gaps and weekly resets.',
        ...
        weeklyValueCarried: 'Carried from {date} (low confidence)',
    ...
    fr: {
      ...
      analytics: {
        ...
        weeklyValueModelDescription: 'Les valeurs par modèle proviennent des fenêtres exclusives quand elles existent. Un usage mixte peut utiliser un ajustement à faible confiance entraîné sur des intervalles adaptatifs sans chevauchement des 28 derniers jours. La dernière valeur acceptée peut être reportée jusqu’à 7 jours pendant les lacunes ordinaires et les resets hebdomadaires.',
        ...
        weeklyValueCarried: 'Reportée depuis le {date} (confiance faible)',
