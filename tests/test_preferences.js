...
if (defaults.CodexPreferences.t('dashboard.dataAge', { age: '1 min' }) !== 'data age: 1 min') fail('dashboard data age translation includes a status or separator');
...
if (defaults.CodexPreferences.t('dashboard.dataAge', { age: '1 min' }) !== 'âge des données : 1 min') fail('French dashboard data age translation includes a status or separator');
